...
for x in range (0, 1000, 1):
    ...
    servo13.move (f_13(10-(x/100.0)))
    servo14.move ( f_14(10-(x/100.0)) )
    servo21.move (f_11(x/100.0) )
    servo22.move ( f_12(x/100.0) )
    servo23.move (f_13(10-(x/100.0)))
    servo24.move ( f_14(10-(x/100.0)) )
    time.sleep(.0001)
quit()